...
class MediapipeManager():
    """Responsible for managing requests for MediaPipe.
    ...
    def __init__(self, output_folder):
        ...
        Arguments:
            output_folder {str} -- path from which the file that will be\
                                   generated by Mediapipe will be saved
        """
    ...
    def run_mediapipe(self, video_path):
        ...
        Raises:
            FileExistsError: provider video path not found
        """

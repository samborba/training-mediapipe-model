...
def get_float_list_at(key, index, sequence, prefix=""):
    return sequence.feature_lists.feature_list[merge_prefix(prefix, key)].feature[index].float_list.value


def get_int_list_at(key, index, sequence, prefix=""):
  return sequence.feature_lists.feature_list[merge_prefix(prefix, key)].feature[index].int64_list.value
